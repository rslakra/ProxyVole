 ...
 * </p>
 * <ul>
 * <li><i>org.gnome.system.proxy.http enabled</i>                 ->   bool     used only by gnome-vfs </li>
 * <li><i>org.gnome.system.proxy.http host</i>                    ->   string   "my-proxy.example.com" without "http://"</li>
 ...
 * <li><i>org.gnome.system.proxy mode</i>                         ->   string   THIS IS THE CANONICAL KEY; SEE BELOW</li>
 * <li><i>org.gnome.system.proxy use-same-proxy</i>               ->   bool</li>
 * <li><i>org.gnome.system.proxy.https host</i>                   ->   string   "proxy-for-https.example.com"</li>
 * <li><i>org.gnome.system.proxy.https port</i>                   ->   int</li>
 * <li><i>org.gnome.system.proxy.ftp host</i>                     ->   string   "proxy-for-ftp.example.com"</li>
 * <li><i>org.gnome.system.proxy.ftp port</i>                     ->   int</li>
 * <li><i>org.gnome.system.proxy.socks host</i>                   ->   string   "proxy-for-socks.example.com"</li>
 * <li><i>org.gnome.system.proxy.socks port</i>                   ->   int</li>
 * <li><i>org.gnome.system.proxy autoconfig-url</i>               ->   string   "http://proxy-autoconfig.example.com"</li>
 * </ul>
 * <i>org.gnome.system.proxy mode</i> can be either:<br/>
 * "none" -> No proxy is used<br/>
 * "manual" -> The user's configuration values are used (org.gnome.system.http_proxy/{host,port,etc.})<br/>
...
public class GnomeDConfProxySearchStrategy implements ProxySearchStrategy {
	...
	private boolean useForAllProtocols(Properties settings) {
		return Boolean.parseBoolean(
				settings.getProperty("org.gnome.system.proxy use-same-proxy", "false"));
	}
